...
* **Diacritics and Language Scripts** - many languages contain diacritics (symbols attached to letters to indicate different pronunciation e.g ç in façade) and some languages use specific scripts e.g Hangul (한글) script for Korean.
